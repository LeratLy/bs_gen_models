...
"""
This is only for debugging purposes, the tests do not need to pass
"""
...
#         self.assertEqual(TrainMode.latent_diffusion, self.trainer._wrapper_model.conf.train_mode)
#         self.trainer.train()
#
...
#             loss, _ = self.trainer._wrapper_model(features, batch_index, True)
#             print(loss)
#
#
