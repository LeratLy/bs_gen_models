...
class ScheduleSampler(ABC):
    ...
    terms are reweighed, allowing for actual changes in the objective.
    """
...
class UniformSampler(ScheduleSampler):
    """
    A Uniform sampler extends :class:`.ScheduleSampler`. It uses weights which are have a uniform porbability.
    Therefore, each timestep is equally probable
    """
